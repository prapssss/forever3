...
public class ValidationUtil {
    ...
    public static boolean isValidImageExtension(Part image_url) {
        if (image_url == null || isNullOrEmpty(image_url.getSubmittedFileName())) {
            return false;
        }
        String fileName = image_url.getSubmittedFileName().toLowerCase();
